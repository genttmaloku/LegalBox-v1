...
<input type="checkbox" id="my-modal-view-{{$rep->id}}" class="modal-toggle" />
<div class="modal">
  <div class="modal-box w-11/12 max-w-5xl">
    <h1 class="mb-2  text-4xl font-extrabold text-gray-900 text-white md:text-4xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Report {{$rep->id}}</span></h1>
    <p class="mt-1 mb-2 text-gray-500">{{$rep->description}}</p>
    <div class="flex items-center">
   

  </div>
    <div class="modal-action">
      <label for="my-modal-view-{{$rep->id}}" class="btn">Exit</label>
    </div>
  </div>
</div>
@endforeach
    ...
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
        <div class="flex p-0 m-0 antialiased text-gray-900 " >
          ...
          @if(Session::has('success'))
            ...
            <h1 class="ml-4 text-normal text-6xl font-extrabold text-gray-900 text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Reports</span></h1>
          </div>
                            ...
                            <div class=" flex justify-start ml-3 mt-3  max-w-4xl py-10 px-10 bg-neutral rounded-lg shadow-md">
                                ...
                                <div class="  ">
                                  ...
                                  <div class="flex justify-start">
                                    <h1 class="  text-4xl font-extrabold text-gray-900 text-white md:text-4xl lg:text-4xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Report {{$rep->id}}</span></h1>
                                ...
                                <div class="flex">
                                    ...
                                    <p class=" mb-2 text-gray-500">{{Str::limit($rep->description,30)}}</p>
                                </div>
                                <label for="my-modal-view-{{$rep->id}}" class="btn mt-1  bg-neutral-800 btn-sm text-teal-300  "><i class="fas fa-info"></i><p class="ml-2 "> Info</p></label>
