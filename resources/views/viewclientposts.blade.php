    ...
    <div x-data="setup()" x-init="$refs.loading.classList.add('hidden');" @resize.window="watchScreen()">
        <div class="flex p-0 m-0 antialiased text-gray-900 " >
          ...
          <div class="flex flex-col flex-1 ">
            ...
            <form action="{{URL('/postsearchcategory')}}" type="get" method="GET">
                @csrf
            <div class="flex ml-28 justify-start">
                
                    
                <select name="category"  class="justify-start input text-blue-300 input-bordered input-teal-500 w-full max-w-xs">
                   ...
                   <button class="ml-2 bg-blue-300 btn text-neutral hover:bg-teal-300 " type="submit">Sort</button>
                  </div>
                </form>
